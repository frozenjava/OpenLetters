...
val LocalNavigationState = compositionLocalOf<NavigationState> { error("NavigationState not provided") }
...
fun rememberNavigationState(
    ...
    return remember(startRoute, topLevelRoute) {
        NavigationState(
            ...
            backStacks = backStacks.toMutableMap(),
        )
    }
}
...
class NavigationState(
    ...
    val backStacks: MutableMap<NavKey, NavBackStack<NavKey>>,
) {
