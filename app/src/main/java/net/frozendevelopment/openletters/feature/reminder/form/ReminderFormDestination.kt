...
val LetterListNavType = object : NavType<List<LetterId>>(isNullableAllowed = false) {
    override fun get(bundle: Bundle, key: String): List<LetterId> {
    ...
    override fun put(bundle: Bundle, key: String, value: List<LetterId>) {
